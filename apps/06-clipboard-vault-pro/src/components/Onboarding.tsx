...
import { ClipboardStackIllustration, FolderTabsIllustration, LockShieldIllustration } from "./illustrations";
...
const SLIDES: Slide[] = [
  {
    title:       "Your Personal Snippet Vault",
    description: "Save text, URLs, code, emails, and phone numbers. Each snippet is auto-tagged by type and stays one click away.",
    render: () => <ClipboardStackIllustration />,
  },
  {
    title:       "Organise with Tags & Collections",
    description: "Group snippets into named collections, add tags, pin the ones you reach for most, and favourite the rest.",
    render: () => <FolderTabsIllustration />,
  },
  {
    title:       "Privacy-First — Stays on Your Device",
    description: "Everything you paste in lives in your browser's localStorage. No accounts, no cloud sync, no telemetry. Clear it any time.",
    render: () => <LockShieldIllustration />,
  },
];

const KEY = "clipboard_onboarding_done";
