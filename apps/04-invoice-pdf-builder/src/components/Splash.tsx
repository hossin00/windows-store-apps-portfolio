  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center"
      ...
      <div className="splash-logo rounded-2xl flex items-center justify-center mb-5"
        style={{ width: 72, height: 72, background: `linear-gradient(135deg,${ACC},${ACC_DEEP})`, boxShadow: `0 16px 48px rgba(245,158,11,.35)` }}>
        <Receipt size={36} color="#ffffff" strokeWidth={2} />
      </div>
      <p className="text-xl font-semibold tracking-tight" style={{ color: "#f1f5f9" }}>Invoice PDF Builder</p>
      <p className="text-xs mt-1.5 mb-7" style={{ color: "#64748b" }}>Invoices, locally and instantly</p>
