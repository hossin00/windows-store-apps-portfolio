...
// ─── Badge ────────────────────────────────────────────────────────────────────
type BadgeV = "default" | "orange" | "green" | "amber" | "red" | "purple" | "blue";
...
export function TextField({ label, value, onChange, placeholder, type = "text", multiline, rows = 3, mono, suffix, prefix, min, max, step }: {
  label?: string; value: string; onChange: (v: string) => void;
  placeholder?: string; type?: string; multiline?: boolean; rows?: number;
  mono?: boolean; suffix?: string; prefix?: string;
      ...
      {multiline ? (
        ...
        <div className="flex items-stretch">
          ...
          <input type={type} value={value} placeholder={placeholder}
            ...
            style={{ ...sharedStyle, borderLeft: prefix ? 0 : sharedStyle.border as string, borderRight: suffix ? 0 : sharedStyle.border as string }} />
          {suffix && (
