...
const SLIDES: Slide[] = [
  {
    ...
    description: "Set your business profile once. Each new invoice auto-numbers, picks up your defaults, and is ready to send.",
    render: () => <ScanDocIllustration />,
  },
  {
    title:       "Live Preview as You Type",
    description: "Watch the invoice render in real time as you type — clients, line items, tax, discount, totals. The PDF matches what you see.",
    render: () => <ShieldDocIllustration />,
  },
  {
    title:       "Real PDF, Saved Locally",
    description: "Export a real A4 PDF generated locally with pdf-lib. Save drafts to history, duplicate next month, re-edit anytime.",
    render: () => <ExportIllustration />,
  },
];

const KEY = "invoice_onboarding_done";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center animate-fade-in"
      ...
      <div className="rounded-2xl shadow-2xl flex flex-col"
        ...
        <div className="flex flex-col items-center pt-10 pb-6 px-10"
          style={{ background: "linear-gradient(180deg, rgba(245,158,11,0.06), transparent)" }}>
