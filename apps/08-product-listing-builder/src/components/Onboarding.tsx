...
import { ProductCardIllustration, PlatformsIllustration, PublishEverywhereIllustration } from "./illustrations";
...
const SLIDES: Slide[] = [
  {
    title:       "Build Product Listings Fast",
    description: "Fill in the structured editor once — name, price, features, tags, SEO, images — and Product Listing Builder turns it into a marketplace-ready listing in seconds.",
    render: () => <ProductCardIllustration />,
  },
  {
    title:       "Preview Per Platform",
    description: "See exactly how your listing looks on Amazon, eBay, Etsy, Shopify, WooCommerce, and a generic preview — with platform-specific title length, format, and SEO scoring.",
    render: () => <PlatformsIllustration />,
  },
  {
    title:       "Export and Publish Anywhere",
    description: "Export single listings or a whole batch as JSON / TXT, and use the CSV bulk importer to load a spreadsheet straight into the vault. All local, no upload, no account.",
    render: () => <PublishEverywhereIllustration />,
  },
];

const KEY = "listing_onboarding_done";
