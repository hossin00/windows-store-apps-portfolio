  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center"
      ...
      <div className="splash-logo rounded-2xl flex items-center justify-center mb-5"
        style={{ width: 72, height: 72, background: `linear-gradient(135deg,${ACC},${ACC_DEEP})`, boxShadow: `0 16px 48px rgba(59,130,246,.35)` }}>
        <FileText size={36} color="#ffffff" strokeWidth={2} />
      </div>
      <p className="text-xl font-semibold tracking-tight" style={{ color: "#f1f5f9" }}>PDF OCR Desk</p>
      <p className="text-xs mt-1.5 mb-7" style={{ color: "#64748b" }}>Local-first OCR for Windows</p>
