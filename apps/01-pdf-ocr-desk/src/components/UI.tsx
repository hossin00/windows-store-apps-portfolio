...
// ─── StatusBadge ──────────────────────────────────────────────────────────────
const STATUS_CFG: Record<OCRStatus, { color: string; label: string; pulse: boolean }> = {
  waiting:    { color: "#64748b", label: "Waiting",    pulse: false },
  processing: { color: "#a78bfa", label: "Processing", pulse: true  },
  completed:  { color: "#22c55e", label: "Completed",  pulse: false },
  failed:     { color: "#ef4444", label: "Failed",     pulse: false },
};
export function StatusBadge({ status }: { status: OCRStatus }) {
