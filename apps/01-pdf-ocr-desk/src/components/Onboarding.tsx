...
const SLIDES: Slide[] = [
  {
    ...
    description: "Drop scanned PDFs or images and get clean, editable text. Optimised for invoices, receipts, contracts, and handwritten notes.",
    render: () => <ScanDocIllustration />,
  },
  {
    title:       "Your Files Stay on Your Device",
    description: "OCR runs entirely on your computer. No uploads, no accounts, no telemetry. Your documents never leave Windows.",
    render: () => <ShieldDocIllustration />,
  },
  {
    title:       "Export Everywhere",
    description: "Copy to clipboard, save as TXT or Markdown, or send an entire batch to your favourite tool. Your workflow, your output.",
    render: () => <ExportIllustration />,
  },
];

const KEY = "pdfocr_onboarding_done";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center animate-fade-in"
      ...
      <div className="rounded-2xl shadow-2xl flex flex-col"
        ...
        <div className="flex flex-col items-center pt-10 pb-6 px-10"
          style={{ background: "linear-gradient(180deg, rgba(59,130,246,0.06), transparent)" }}>
