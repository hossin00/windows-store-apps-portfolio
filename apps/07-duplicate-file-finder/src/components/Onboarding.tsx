...
import { TwinFilesIllustration, ReviewListIllustration, DiskFreeIllustration } from "./illustrations";
...
const SLIDES: Slide[] = [
  {
    title:       "Find Duplicate Files Fast",
    description: "Drop a folder's files into the scanner and Duplicate File Finder groups exact matches by name and size — so you can spot redundancies in seconds.",
    render: () => <TwinFilesIllustration />,
  },
  {
    title:       "Review Before You Delete",
    description: "Every duplicate group shows up with a clear keep / remove checklist. Auto-select keep-newest, keep-oldest, or keep-first — and nothing leaves disk until you confirm.",
    render: () => <ReviewListIllustration />,
  },
  {
    title:       "Reclaim Your Disk Space",
    description: "See exactly how much space you'll free up before applying. Export the scan as CSV or JSON for backup, then clean up with confidence.",
    render: () => <DiskFreeIllustration />,
  },
];

const KEY = "dupefinder_onboarding_done";
