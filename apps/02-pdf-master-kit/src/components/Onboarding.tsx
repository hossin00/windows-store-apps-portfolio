...
const SLIDES: Slide[] = [
  {
    title:       "Six PDF Tools, One App",
    description: "Merge, split, compress, rotate, reorder pages, and extract — every operation is one click with a live preview.",
    render: () => <ScanDocIllustration />,
  },
  {
    title:       "Real PDFs, Real Local",
    description: "Every operation runs in your browser using pdf-lib. Files never leave your computer — no uploads, no accounts, no analytics.",
    render: () => <ShieldDocIllustration />,
  },
  {
    title:       "Drop, Edit, Download",
    description: "Drag PDFs in, tune the operation, and your output downloads to your Downloads folder immediately.",
    render: () => <ExportIllustration />,
  },
];

const KEY = "pdfmaster_onboarding_done";
