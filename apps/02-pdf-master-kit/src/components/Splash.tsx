  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center"
      ...
      <div className="splash-logo rounded-2xl flex items-center justify-center mb-5"
        ...
        <FileStack size={36} color="#ffffff" strokeWidth={2} />
      </div>
      <p className="text-xl font-semibold tracking-tight" style={{ color: "#f1f5f9" }}>PDF Master Kit</p>
      <p className="text-xs mt-1.5 mb-7" style={{ color: "#64748b" }}>Local PDF toolkit for Windows</p>
